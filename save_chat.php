...
$username = htmlspecialchars(trim($_POST['chat_user']), ENT_QUOTES, 'UTF-8');
$email = filter_var(trim($_POST['chat_email']), FILTER_VALIDATE_EMAIL);
$messageText = htmlspecialchars(trim($_POST['chat_message']), ENT_QUOTES, 'UTF-8');
